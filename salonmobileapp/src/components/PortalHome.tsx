...
export function PortalHome({ title, description }: PortalHomeProps) {
  const { user, me, portal, tenantSlug, logout } = useAuth();
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Card>
          ...
          <View style={styles.badges}>
            <Text style={styles.badge}>{portalLabel(portal, user, me ?? undefined)}</Text>
        ...
        <Card style={styles.gap}>
          ...
          <Text style={styles.hint}>
            Staff tools for bookings and schedules are on the way. Sign in on web for the full workplace today.
          </Text>
        </Card>
      </ScrollView>
    </SafeAreaView>
