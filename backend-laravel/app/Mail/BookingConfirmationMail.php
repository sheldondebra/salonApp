...
class BookingConfirmationMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Booking confirmed — {$salon}",
        );
    }

    public function content(): Content
    {
        $this->appointment->loadMissing(['service', 'staffMember', 'tenant', 'location', 'client']);

        return new Content(
            view: 'emails.booking-confirmation-html',
            with: [
                ...
                'staffName' => $this->appointment->staffMember?->display_name,
